...
impl Skeleton for CharacterSkeleton {
    ...
    fn compute_matrices_inner(
        ...
        let computed_skeleton = ComputedCharacterSkeleton {
            ...
            back: chest_mat * Mat4::<f32>::from(transform_other(self.back)),
            shorts: shorts_mat,
            hand_l: control_l_mat * hand_l_mat,
            hand_r: hand_r_mat,
            foot_l: torso_mat * Mat4::<f32>::from(self.foot_l),
            foot_r: torso_mat * Mat4::<f32>::from(self.foot_r),
            shoulder_l: chest_mat * Mat4::<f32>::from(transform_other(self.shoulder_l)),
            shoulder_r: chest_mat * Mat4::<f32>::from(transform_other(self.shoulder_r)),
            glider: glider_mat,
            main: main_mat,
            second: second_mat,
            lantern: lantern_mat,
